namespace QuanLyPhong
{
	partial class Login
	{
		...
		private void InitializeComponent()
		{
			...
			btn_forgotPassword = new Guna.UI2.WinForms.Guna2Button();
			lb_error = new Label();
			...
			guna2GradientPanel1.Controls.Add(btn_forgotPassword);
			...
			guna2GradientPanel1.Location = new Point(-5, -11);
			...
			guna2GradientPanel1.Size = new Size(998, 630);
			...
			tb_username.Location = new Point(549, 195);
			...
			tb_username.Size = new Size(365, 50);
			tb_username.TabIndex = 9;
			tb_username.TextOffset = new Point(20, 0);
			// 
			// btn_forgotPassword
			// 
			btn_forgotPassword.BorderRadius = 18;
			btn_forgotPassword.CustomizableEdges = customizableEdges3;
			btn_forgotPassword.DisabledState.BorderColor = Color.DarkGray;
			btn_forgotPassword.DisabledState.CustomBorderColor = Color.DarkGray;
			btn_forgotPassword.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
			btn_forgotPassword.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
			btn_forgotPassword.FillColor = Color.FromArgb(0, 192, 192);
			btn_forgotPassword.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
			btn_forgotPassword.ForeColor = Color.Black;
			btn_forgotPassword.Location = new Point(570, 439);
			btn_forgotPassword.Margin = new Padding(3, 2, 3, 2);
			btn_forgotPassword.Name = "btn_forgotPassword";
			btn_forgotPassword.PressedColor = Color.Blue;
			btn_forgotPassword.ShadowDecoration.CustomizableEdges = customizableEdges4;
			btn_forgotPassword.Size = new Size(316, 35);
			btn_forgotPassword.TabIndex = 8;
			btn_forgotPassword.Text = "FOGOT PASSWORD";
			...
			lb_error.Location = new Point(641, 353);
			lb_error.Name = "lb_error";
			lb_error.Size = new Size(170, 15);
			lb_error.TabIndex = 7;
			...
			btn_login.Location = new Point(570, 381);
			...
			btn_login.Size = new Size(316, 35);
			...
			tb_password.Location = new Point(549, 276);
			...
			tb_password.Size = new Size(365, 50);
			...
			label1.Location = new Point(653, 108);
			label1.Name = "label1";
			...
			guna2CirclePictureBox1.Location = new Point(73, 151);
			...
			guna2CirclePictureBox1.Size = new Size(366, 278);
			...
			btn_Exit.Location = new Point(954, 19);
